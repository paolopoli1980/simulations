...
#calcola al tempo t tutti i campi magnetici da dipoli che agiscono su singolo dipolo       
   ...
   # zoomzfin=input("inserisci z punto finestra finale =")
    ...
    interazioni=raw_input("inserisci le interazioni da attivare (dipolo-dipolo,exchange,isotropico) (111,per attivarli tutti)=")
    ...
    zconfig=raw_input("premi z per configure i dipoli allineati sull'asse Z,m per allinearli metà-metà,p in modo lieve,x allineati sull'asse x,b in modalità xz allineamento=")
