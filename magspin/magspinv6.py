...
#fine dichiarazione
oscillation = graph(xtitle='t', ytitle='Mx=green,My=yellow,Mz=red,|M|=cyan')
...
#    testo = text(pos=vector((0,0,altezza/deltaz+1),text="z", align='center', depth=-0.3, color=color.white,height=0.5)
    rate(1000) 
    list1=[]
    list2=[]
    list21=[]
...
def dipolo_classico3d():
    ...
    def moto_dipoli3d(conta_tantum,choose,fatcoefj,Bz,alfa,alfa2,rapporto):
        rate(10) 
     ...
     #qui memomrizzo tutti i valori dei momenti magnetici in modo da poterli usare nei calcoli
        ...
        for i in range(0,int(numero_dipoli)):
             #interazione dipolo-dipolo
              if (interazioni[0:1]=='0' and Bz!=0):
                  campomagneticox[i]=0
                  campomagneticoy[i]=0
                  campomagneticoz[i]=Bz
             ...
             #**************************************************
              ...
              if (interazioni[0:1]=='0' and Bz!=0):
                  somma_deltax[choose][i]=delta_mux
                  somma_deltay[choose][i]=delta_muy
                  somma_deltaz[choose][i]=delta_muz
             ...
             # print (s_deltax,s_deltay,s_deltaz)
...
#calcola al tempo t tutti i campi magnetici da dipoli che agiscono su singolo dipolo       
    ...
    #dati di ingresso  
  #  lunghezza=input("inserisci la lunghezza della griglia in nm=")
  #  larghezza=input("inserisci la larghezza della griglia in nm=")
  #  altezza=input("Inserisci l'altezza della griglia in nm=")  
   ...
   # dt=input("inserisci dt in secondi=")
   # tempofine=input("inserisci il tempo di stop in secondi=")
   # alfa=input("inserisci il coefficiente esponenziale per le interazioni spin-spin=")
   # fatcoefj=input("inserisci il fattore coefj=")
   # rapporto=input("inserisci coefficiente(coef) D=coef*J =")
   # interazioni=input("inserisci le interazioni da attivare (dipolo-dipolo,exchange,isotropico) (111,per attivarli tutti)=")
   # tantum=input("inserisci ogni quanti valori memorizzare i frames= ")
  ...
  #riempie il reticolo di dipoli con norma uguale al magnetone di Bohr
    ...
    while (i <int(numero_dipoli)):
        ...
        if (reticolo[ii][jj][kk]==0):
            ...
            y.append(jj) 
            z.append(kk) 
            vx.append(sqrt(random.uniform(0,1)/2))
            vy.append(sqrt(random.uniform(0,1)/2))
            vz.append(0)
   ...
   # if zconfig=='z':
    ...
    while (tempo<tempofine):
        ...
        dt=dt/2
      #  print(dt)
        if (float(interazioni[0:1])==1 or Bz!=0):
        ...
        choose=0
        moto_dipoli3d(conta_tantum,choose,fatcoefj,Bz,alfa,alfa2,rapporto)  
        ...
        moto_dipoli3d(conta_tantum,choose,fatcoefj,Bz,alfa,alfa2,rapporto) #calcola i c2
        ...
        moto_dipoli3d(conta_tantum,choose,fatcoefj,Bz,alfa,alfa2,rapporto) #calcola i c3
        ...
        moto_dipoli3d(conta_tantum,choose,fatcoefj,Bz,alfa,alfa2,rapporto) #calcola i c4
        kk=0
        energia=0
        magx=0
        magy=0
