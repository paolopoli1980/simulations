...
for i in range(1,numberdots-1):
    ...
    dotsx[i].connections=[i-1,i,i+1]

dotsx[numberdots-1].connections=[numberdots-2,numberdots-1,0]
dotsx[0].connections=[numberdots-1,0,1]
'''
...
for i in range(numberdots):
    dotsx[i].states=[1,0,0,1,1,0,0,1]
