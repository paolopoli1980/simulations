...
nentity=input("Insert the number of the entities=")
#nentity=130
#ndim=input("Number of the dimensions (max 3)=")
dimwindowsquare=input("Lenght and height of the square windows=")
ndim=2
obj=[]
#dimwindow=[5,5]
dimwindow=[dimwindowsquare,dimwindowsquare]
nprey=input("Number of preys=")

#nprey=100
#npredator=30
npredator=input("Number of predators=")
#step=0.02
step=input("Insert the step (0.02 is good)=")
nsteps=input("Insert the total number of steps=")
#nsteps=1000
eatingdist=input("Insert the eating distance (0.02 is good)")
#eatingdist=0.02
typeofsimulation=input("Insert (1 for Gredy alg.) (2 for the closest predator to catch the prey alg.)=")
