...
class robot:
    ...
    def movement(self,n,key,dyn):
        ...
        for i in range(0,narms-n):
            vecdistx[i]=self.rot_vector(vecdistx[i],vecdisty[i],vecdistz[i],key)[0]
            vecdisty[i]=self.rot_vector(vecdistx[i],vecdisty[i],vecdistz[i],key)[1]
            vecdistz[i]=self.rot_vector(vecdistx[i],vecdisty[i],vecdistz[i],key)[2]
        sx=0
        sy=0
        sz=0
        for i in range (n):
...
def build_arms():
    ...
    for el in arms:
        i+=1
        cyl.append(cylinder(pos=(el.x,el.y,el.z),axis=(el.ux,el.uy,el.uz),radius=1.0/i))
