...
def ising_bidimensionale(coefj,delta_temperatura,tipo_allineamento,n_spinx,n_spiny,temperatura_iniziale,temperatura_finale,interazioni,b,coefmu,kboltz):
    ...
    while (conta_colonna<numero_passi-2):
        ...
        if temperatura>0:
            ...
            # metodo di montecarlo.....         
                energia=energia+delta_energia-2*coefmu*b*spin[casual,casual2]   
              
                if delta_energia>0:
 
                    tiro=np.random.uniform(0,1) 
                 
                if tiro>np.exp(-delta_energia/ (kboltz*temperatura)):
...
def ising_monodimensionale(coefj,delta_temperatura,tipo_allineamento,n_spin,temperatura_iniziale,temperatura_finale,interazioni,conta_k,b,coefmu,kboltz):
   ...
   #inizia il ciclo incrementando o decrementando le temperatura 
    while (conta_colonna<numero_passi):
        print (temperatura)
        conta_colonna=conta_colonna+1        
            ...
            #sceglie uno spin a caso e lo gira processandolo con Montecarlo
                ...
                if (somma==-1):
                    delta_energia=spin[casual]*coefj* 2
                     ...
                     #montecarlo.....         
                energia=energia+delta_energia-2*coefmu*b*spin[casual]    
...
temperatura_iniziale=3
temperatura_finale=0.02
delta_temperatura=0.02
numero_iterazioni=1200 #numero di possibilità al cambio spin per la stessa temperatura
n_spin=800#numero di spin nel caso 1D
...
n_spinx=30 # numero di spin nel caso 2D
n_spiny=30                            #
conta_k=1 # serve nel 1D disegna nel grafico temporale un set di spin ogni conta_k
 
 
 
#ising_monodimensionale(coefj,delta_temperatura,tipo_allineamento,n_spin,temperatura_iniziale,temperatura_finale,numero_iterazioni,conta_k,b,coefmu,kboltz)   
ising_bidimensionale(coefj,delta_temperatura,tipo_allineamento,n_spinx,n_spiny,temperatura_iniziale,temperatura_finale,numero_iterazioni,b,coefmu,kboltz)
